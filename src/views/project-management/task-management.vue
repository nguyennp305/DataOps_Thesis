...
<script>
// import component
import Datatable from '@/views/project-management/components-tasks/datatable'
import FilterSearch from '@/views/project-management/components-tasks/filter-search'
import TaskModal from '@/components/Modal/taskModal'
// import function call api.
import { getTaskList, deleteTaskById } from '@/api/project-management/task-list'
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      this.$confirm(
        'Confirm to remove this task? (not multiple language)',
        'Warning',
        {
