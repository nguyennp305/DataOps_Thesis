...
<script>
// import component
import Datatable from '@/views/project-management/components-reports/datatable'
import FilterSearch from '@/views/project-management/components-reports/filter-search'
import ReportProjectModal from '@/components/Modal/reportProjectModal.vue'
// import function call api.
import { getReportList, deleteReportById } from '@/api/project-management/report-list'
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      this.$confirm(
        'Confirm to remove this report? (not multiple language)',
        'Warning',
        {
