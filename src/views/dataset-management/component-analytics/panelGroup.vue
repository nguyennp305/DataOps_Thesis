  ...
  <el-row :gutter="40" class="panel-group">
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel">
        <div class="card-panel-icon-wrapper icon-tree">
          <svg-icon name="tree" class="card-panel-icon" />
        </div>
        <div class="card-panel-description">
          <div class="card-panel-text">Datasets</div>
          <count-to
            :start-val="0"
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel">
        <div class="card-panel-icon-wrapper icon-qq">
          <svg-icon name="qq" class="card-panel-icon" />
        </div>
        <div class="card-panel-description">
          <div class="card-panel-text">Labels</div>
          <count-to
            :start-val="0"
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel">
        <div class="card-panel-icon-wrapper icon-documentation">
          <svg-icon name="documentation" class="card-panel-icon" />
        </div>
        <div class="card-panel-description">
          <div class="card-panel-text">Images</div>
          <count-to
            :start-val="0"
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel">
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">Labeled Images</div>
          <count-to
            :start-val="0"
            :end-val="panelGroupData.labeledImages"
            :duration="3600"
            class="card-panel-num"
          />
        </div>
